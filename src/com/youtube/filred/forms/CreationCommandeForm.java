...
public final class CreationCommandeForm {
	...
	private static final String CHAMP_CHOIXCLIENT    = "choixNouveauClient";
    private static final String CHAMP_LISTECLIENTS   = "listeClients";
	...
	public Commande creerCommande( HttpServletRequest request, String chemin ) {
	         ...
	         * effectuer
	         */
	        String choixNouveauClient = getValeurChamp( request, CHAMP_CHOIXCLIENT );
	        if ( ANCIEN_CLIENT.equals( choixNouveauClient ) ) {
	            /* Récupération du nom du client choisi */
	            String nomAncienClient = getValeurChamp( request, CHAMP_LISTECLIENTS );
