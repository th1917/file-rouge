package com.youtube.filred.forms;
...
public final class CreationClientForm {
    ...
    public static final String CHAMP_IMAGE     = "imageClient";
    
    public static final int TAILLE_TAMPON     = 10240;         // pour 10ko
    ...
    public Client creerClient( HttpServletRequest request, String chemin ) {
	    ...
	    try {
	        validationAdresseLivraison( adresse );
	    } catch ( Exception e ) {
    ...
    private void validationNom( String nom ) throws Exception{
    	 if ( nom != null ) {
    		 if (nom.length() < 2 ) {
    			 throw new Exception( "Le nom client doit contenir au moins 2 caractères." );
    		 }
    	 }else {
    ...
    private void validationPrenom( String prenom ) throws Exception{
    	 if (prenom != null && prenom.length() < 2 ) {
    	        throw new Exception( "Le prenom client doit contenir au moins 2 caractères." );
    	    }
    }
    
    /*Validation de l'adresse de livraison*/
    private void validationAdresseLivraison( String adresse ) throws Exception{
        if ( adresse != null ) {
        	if(adresse.length() <3 ) {
        		 throw new Exception( "L'adresse de livraison doit contenir au moins 3 caractères." );
        	}
        }else {
